        ...
        <div className="header-container">
            ...
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src="./header_img.png" className="d-block w-100" alt="Delicious food" />
                    ...
                    <div className="carousel-item">
                        <img src="./header3_img.png" className="d-block w-100" alt="Tasty meals" />
                        <div className="header-contents">
                            <h2>Order your favourite food now</h2>
                            <p>Choose from a diverse menu featuring a delectable array of dishes crafted with the finest ingredients and culinary expertise. Our mission is to satisfy your cravings and elevate your dining experience, one delicious meal at a time.</p>
                            <button><a href="#explore-menu">View Menu</a></button>
                    ...
                    <div className="carousel-item">
                        <img src="./header4_img.png" className="d-block w-100" alt="Fresh ingredients" />
                        <div className="header-contents">
                            <h2>Order your favourite food now</h2>
                            <p>Choose from a diverse menu featuring a delectable array of dishes crafted with the finest ingredients and culinary expertise. Our mission is to satisfy your cravings and elevate your dining experience, one delicious meal at a time.</p>
                            <button><a href="#explore-menu">View Menu</a></button>
            ...
            <div className="promotions-section">
                <div className="promo">
                    ...
                    <button className="promo-button"><a
                        href="#explore-menu " >
                        Shop All </a></button>
                </div>
