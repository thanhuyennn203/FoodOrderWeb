    ...
    <div className='cart'>
      <div className="cart-items">
        <div className="cart-items-title">
          <p>Items</p> <p>Title</p> <p>Price (VND)</p> <p>Quantity</p> <p>Total (VND)</p> <p>Remove</p>
        </div>
        <br />
        <hr />
            ...
            return (
              <div key={index}>
                <div className="cart-items-title cart-items-item">
                  ...
                  <p>{item.food_name}</p>
                  <p>{item.food_price} VND</p> 
                  <div>{cartItems[item.food_id]}</div>
                  <p>{item.food_price * cartItems[item.food_id]} VND</p> {/* Total in VND */}
      ...
      <div className="cart-bottom">
        <div className="cart-total">
          ...
          <div>
            ...
            <div className="cart-total-details">
              <b>Total</b>
              <b>{getTotalCartAmount() === 0 ? 0 : getTotalCartAmount() + 5} VND</b> 
            </div>
          </div>
